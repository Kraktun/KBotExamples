...
class HelloCommand : CommandInterface {
    ...
    val engine = BaseCommand(
        command = "/hello",
        description = "Hi",
        targets = mapOf(Target.USER to Status.NOT_REGISTERED, // NOT_REGISTERED is the lowest acceptable status of the user, all users with a status >= NOT_REGISTERED can use the command
